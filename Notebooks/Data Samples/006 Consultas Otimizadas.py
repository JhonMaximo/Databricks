...
#  Comnando não compativel com Serveless da Free Edition
...
delta_path = "/Volumes/workspace/lhdw/gold/vendas_delta"
...
vendas_df = spark.read.format("delta").load("/Volumes/workspace/lhdw/gold/vendas_delta/fato_vendas")
categoria_df = spark.read.format("delta").load("/Volumes/workspace/lhdw/gold/vendas_delta/dim_categoria")
