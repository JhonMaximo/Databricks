...
# MAGIC %fs ls /Volumes/workspace/lhdw/landingzone/vendas/processado/

# COMMAND ----------

# MAGIC %fs ls /Volumes/workspace/lhdw/bronze/vendas/Ano=2011/Mes=10
...
# MAGIC **Resumo**
# MAGIC
# MAGIC - **Para uma limpeza rápida e geral**: Use spark.catalog.clearCache(). Não Compativel com Free Edition
# MAGIC - **Para liberar memória de DataFrames específicos**: Use df.unpersist(). Não Compativel com Free Edition
